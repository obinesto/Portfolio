    ...
    <div ref={heroRef} className="min-h-screen flex items-center px-8 pt-32">
      <div>
        ...
        <div className="hero-anim">
          ...
          >
            A full stack engineer with experience building web apps with modern
        ...
        <Link
          href="https://drive.google.com/file/d/12ZEyYeNNH1N-cdrgOETBvgUz5pXo3IQj/view?usp=sharing"
          target="blank"
